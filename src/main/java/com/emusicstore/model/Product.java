...
public class Product {
	...
	private String productCandition;
	...
	public String getProductCandition() {
		return productCandition;
	}
	public void setProductCandition(String productCandition) {
		this.productCandition = productCandition;
	}
	...
	public String toString() {
		return "Product [productName=" + productName + ", productCategory=" + productCategory + ", productDescription="
				+ productDescription + ", produtPrice=" + produtPrice + ", productCandition=" + productCandition
